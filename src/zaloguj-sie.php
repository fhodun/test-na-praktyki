...
<head>
  <title>Książka adresowa - zaloguj się</title>
      ...
      <div class="collapse navbar-collapse" id="navbarsupportedcontent">
        <ul class="navbar-nav me-auto mb-2 mb-lg-0">
          ...
          if (isset($_SESSION["zalogowany"]) && $_SESSION["zalogowany"] == true) {
            ...
            echo ('
            <li class="nav-item">
              <a class="nav-link active" href="./zaloguj-sie.php">Zaloguj sie</a>
            </li>
            <li class="nav-item">
      ...
      <div id="row1" class="row pt-5">
        ...
        if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST["submit"])) {
          ...
          if (!isset($err)) {
            ...
            echo ('<div class="alert alert-success mb-5" role="alert">Zalogowano pomyślnie</div>');
          } else {
