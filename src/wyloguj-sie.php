...
<head>
  <title>Książka adresowa - wyloguj się</title>
      ...
      <div class="collapse navbar-collapse" id="navbarsupportedcontent">
        <ul class="navbar-nav me-auto mb-2 mb-lg-0">
          ...
          if (isset($_SESSION["zalogowany"]) && $_SESSION["zalogowany"] == true) {
            ...
            <li class="nav-item">
              <a class="nav-link active" href="./wyloguj-sie.php">Wyloguj się</a>
            </li>
            ');
          } else {
            echo ('
  ...
  <main>
    <div class="container">
      <div id="row1" class="row pt-5">
        ...
        if (session_destroy()) {
          echo ('
            <div class="alert alert-success mb-5" role="alert">Wylogowano pomyślnie</div>
            ');
        } else {
          echo ('
            <div class="alert alert-danger mb-5" role="alert">Wystąpił niespodziewany błąd</div>
            ');
        }
        ?>
      </div>
